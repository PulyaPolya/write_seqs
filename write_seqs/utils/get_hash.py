"""
After https://github.com/lemon24/reader/blob/1efcd38c78f70dcc4e0d279e0fa2a0276749111e/src/reader/_hash_utils.py
...
def get_hash(thing: object) -> bytes:
    digest = hashlib.md5(_json_dumps(thing).encode("utf-8")).hexdigest()
    return digest[:-1]
