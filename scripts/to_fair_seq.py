...
Input to the fairseq binarizer should look like this (NB we don't require the target dict):

```
dict.input.txt	  midi_test.txt   midi_valid.txt    targets_train.txt
...
Then, input to fairseq binarizer script should look like:

```
dict.input.txt      midi_train.txt      targets_0_test.txt  targets_0_valid.txt targets_1_train.txt
